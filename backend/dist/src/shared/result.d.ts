...
export type DomainError = {
    ...
    code: 'SLOT_RESERVATION_EXPIRED';
    slotId: string;
} | {
    code: 'APPOINTMENT_IN_PAST';
} | {
    code: 'BELOW_MIN_ADVANCE_NOTICE';
    minHours: number;
} | {
    code: 'APPOINTMENT_NOT_FOUND';
    id: string;
} | {
    code: 'APPOINTMENT_ALREADY_PAST';
    id: string;
} | {
...
export declare function err<E = DomainError>(error: E): Result<never, E>;
