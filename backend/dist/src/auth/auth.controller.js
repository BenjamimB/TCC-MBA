...
let AuthController = class AuthController {
    ...
    async refresh(body) {
        ...
        if (!result.ok)
            throw Object.assign(new Error(result.error.code), { status: 401, error: result.error });
        return result.value;
    }
    async logout(body) {
    ...
    async verifyEmail(body) {
        ...
        if (!result.ok)
            throw Object.assign(new Error(result.error.code), { status: 400, error: result.error });
    }
